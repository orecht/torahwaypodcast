...
```
    cd "TorahWayPodcast.AWSLambda"
    dotnet restore
```

Execute unit tests
```
    cd "TorahWayPodcast.AWSLambda/test/TorahWayPodcast.AWSLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "TorahWayPodcast.AWSLambda/src/TorahWayPodcast.AWSLambda"
